...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "lmdoom-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/lmdoom"
  #   chef.validation_client_name = "lmdoom-validator"
  #   chef.validation_key_path = ".chef/lmdoom-validator.pem"
  # end
end
